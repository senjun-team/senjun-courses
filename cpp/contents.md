...
- Глава 2.1. Переменные и функции [DONE]
    - Правила именования
...
# Глава 3. Условия [DONE]
- Глава 3.1. Условия if-else и тернарный оператор [DONE]
    - Условия if-else
        - Когда фигурные скобки обязательны, а когда - опциональны?
        - Вложенные условия
    - Тернарный оператор
- Глава 3.2. Конструкция switch-case [DONE]
    - Как выглядит switch-case
        - Оператор break

# Глава 4. Циклы  [DONE]
- Глава 4.1. Циклы while и do-while  [DONE]
    - Цикл while
    - Цикл do-while
- Глава 4.2. Циклы for и range-for [DONE]
    - Цикл for
    - Цикл range-for
...
- Глава 5.1. Перегрузка функций [DONE]
    - Что такое перегрузка
    - Зачем нужна перегрузка
- Глава 5.2. Исключения [DONE]
    - Как работают исключения
    - Оператор throw
    - Конструкция try-catch
- Глава 5.3. Пространства имён [DONE]
    - Объявление пространства имен
    - Доступ к пространству имен
    - Для чего нужны пространства имен
    - Вложенные пространства имен
- Глава 5.4. Перечисления [DONE]    
    - Перечисления enum
    - Перечисления enum class
- Глава 5.5. Классы и структуры [DONE]
    - Классы
        - Конструкторы и деструкторы
        - Идиома RAII
    - Структуры
- Глава 5.6. Шаблоны [DONE]
    - Шаблоны функций
...
- Глава 6.1. Что такое итератор [DONE]
    - STL
    - Концепция итератора
    - Реализация итераторов в C++
    - Основные действия над итераторами
    - Категории итераторов
- Глава 6.2. Работа с итераторами [DONE]
...
- Глава 7.1. Какие бывают контейнеры  [DONE]
    - Классификация контейнеров
    - Строка - это контейнер?
    - Другие классы, которые похожи на контейнеры
- Глава 7.2. Последовательные контейнеры  [DONE]
    - Класс vector
    - Класс array
    - Абстрактные типы данных и структуры данных
    - Класс deque
    - Классы list и forward_list
- Глава 7.3. Упорядоченные ассоциативные контейнеры  [DONE]
    - Класс pair
    - Класс map
    - Класс set
    - Классы multimap и multiset
- Глава 7.4. Неупорядоченные ассоциативные контейнеры  [DONE]
    - Класс unordered_set
    - Класс unordered_map
    - Классы unordered_multimap и unordered_multiset
- Глава 7.5. Адаптеры  [DONE]
    - Класс queue
...
- Глава 8.1. Немодифицирующие алгоритмы  [DONE]
    - Мотивация применять алгоритмы
    - Обзор алгоритмов стандартной библиотеки
    - Поиск
    - Бинарный поиск
    - Подсчет
- Глава 8.2. Модифицирующие алгоритмы  [DONE]
    - Сортировка
...
- Глава 9.1. Жизненный цикл переменной [DONE]
    - Где живут переменные
    - Время жизни
    - Локальные переменные
    - Глобальные переменные
    - Статические переменные
- Глава 9.2. Приёмы, связанные с областью видимости [DONE]
    - Затенение имен
...
- Глава 11.1. Этапы сборки [DONE]
    ...
    - Ассемблирование
    - Линковка
- Глава 11.2. Подключение библиотек и модулей [DONE]
...
- Глава 11.3. Автоматизация сборки программы [DONE]
    - Что такое CMake
    - Команды CMake
...
# Глава 12. Щадящее введение в инициализацию [DONE]
- Глава 12.1. Основные способы инициализации [DONE]
...
- Глава 12.2. Инициализация полей классов [DONE]
...
# Глава 13. Типы [DONE]
- Глава 13.1. Фундаментальные типы [DONE]
    ...
    - Суффиксы литералов
    - Какой тип выбрать?
- Глава 13.2. Составные типы [DONE]
    - Перечисления
    - Функции
        - Сигнатура функции
        - Тип функции
...
# Глава 14. Ссылки [DONE]
- Глава 14.1. Ссылки: знакомство [DONE]
    - Что такое ссылка
    - Работа со ссылками
    - Передача параметров в функцию по ссылке
    - Использование ссылок в цикле range-for
    - Ссылки и константность
- Глава 14.2. Нюансы работы со ссылками [DONE]
...
# ПРОЕКТ. Калькулятор алгебраических выражений [DONE]
- Для строки с алгебраическим выражением, например, "81.0-(2.5+1)/3", вернуть его значение


# Глава 15. Указатели [DONE]
- Глава 15.1. Зачем нужны указатели [DONE]
    ...
    - План действий
- Глава 15.2. Основы работы с указателями [DONE]
...
- Глава 15.3. Адресная арифметика [DONE]
...
- Глава 15.4. Динамическое выделение памяти [DONE]
...
- Глава 15.5. Динамическое выделение памяти для массивов [DONE]
...
- Глава 15.6 Указатели на указатели. Ссылки на указатели [DONE]
...
- Глава 15.7 Знакомство с умными указателями [DONE]
    - Мотивация
    - Концепция владения
...
# ПРОЕКТ. AVL-дерево [IN PROGRESS]
- Используя умные указатели, реализовать класс для AVL-дерева
