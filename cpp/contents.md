...
- Глава 13.1. Основные способы инициализации [DONE]
...
- Глава 13.2. Инициализация полей классов [DONE]
...
# Глава 14. Типы [DONE]
- Глава 14.1. Фундаментальные типы [DONE]
    ...
    - Суффиксы литералов
    - Какой тип выбрать?
- Глава 14.2. Составные типы [DONE]
    - Перечисления
    - Функции
        - Сигнатура функции
        - Тип функции
...
# Глава 16. Указатели [IN PROGRESS]
- Глава 16.1. Основы работы с указателями [DONE]
    - Что такое указатель
...
- Глава 16.2. Адресная арифметика [IN PROGRESS]
- Глава 16.3. Динамическое выделение памяти [IN PROGRESS]
