...
Вам предстоит длинный путь, прежде чем вы научитесь подчинять себе силу артефакта и не прельщаться его тёмной стороной. Наш курс призван открыть вам этот путь и помочь с него не сойти. Но осилить вы его должны самостоятельно, иначе магия не сработает.
...
- Решать на C++ задачи из реальной жизни.
...
C++ – самый сложный из мейнстримных языков. Его невозможно выучить полностью. Наш курс концентрируется на современном подмножестве языка и его идиомах, которых достаточно, чтобы писать эффективный, безопасный и читабельный код.
...
Задачи и проекты — важная составляющая курса. Какие-то аспекты C++ вы узнаете именно из них!
...
Наш курс **точно** не пойдёт на пользу, если вы:
...
- Ищете курс, который бы за ручку провёл по настройке IDE и окружения.
...
После того, как вы решили задачу, вы можете **сравнить своё решение с нашим.** Оно доступно по кнопке подсказки.

Многие примеры кода из глав в один клик открываются в **плэйграунде.** Пользуйтесь этим: почаще экспериментируйте с кодом!

И помните: только за счёт практики ваши теоретические знания успешно улягутся в _долговременную_ память.

## Ответы на частые вопросы

### Нужно ли начинать изучение C++ с Си?

Нет. И в следующей главе вы поймёте, почему.
...
Допустим, эту строчку никто никогда не увидит и не прочитает, а если всё-таки увидит и даже прочитает - добровольно-принудительно сделает вид, что её здесь нет.