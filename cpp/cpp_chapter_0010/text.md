...
![Мультитул C++](https://raw.githubusercontent.com/senjun-team/senjun-courses/refs/heads/main/illustrations/cpp/multitool.jpg) {.illustration}
...
В цикле переберем индексы массива и применим это условие к каждому элементу: {#block-naive}
...
- Сконцентрирован только на высокоуровневой логике того, что должна делать программа.
