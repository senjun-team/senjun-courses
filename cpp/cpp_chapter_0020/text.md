...
А началось все с того, что в конце 70-х Бьерн Страуструп (Bjarne Stroustrup) впечатлился классами языка Simula, но остался недоволен его производительностью. Язык C, с другой стороны, отличался быстродействием, но не способствовал удобному объединению данных и методов их обработки. Страуструп создал расширение C и назвал его «С с классами» (C with classes). Оно завоевало популярность, обросло функционалом и было переименовано в C++ (инкремент от C, что намекает на преемственность).
