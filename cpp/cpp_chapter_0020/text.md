...
Операторы удобно рассматривать как функции, операнды которых — аргументы этих функций. Тогда результат операции — это _возвращаемое значение_ соответствующей "функции".
...
Обе формы имеют один и тот же побочный эффект — они изменяют переменную. Разница в возращаемом значении.
