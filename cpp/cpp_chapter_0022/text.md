...
Перед вами значение типа `std::size_t`, которое занимает 4 байта и в бинарном виде выглядит так: {.task_text}

```
11111111 11111111 11111111 11111100
```

Чему станет равно это число после применения к нему оператора `~`? Ответ запишите в десятичной системе счисления. {.task_text}

```consoleoutput {.task_source #cpp_chapter_0022_task_0010}
```
