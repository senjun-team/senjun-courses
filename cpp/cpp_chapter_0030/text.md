...
Вы познакомитесь с тремя вариантами для условного выполнения кода:
...
### Когда фигурные скобки обязательны, а когда — опциональны?

Фигурные скобки объединяют _инструкции_ в блоки. Как вы помните, инструкциями [statements](/courses/cpp/chapters/cpp_chapter_0020/#block-statements) называются фрагменты кода, выполняемые последовательно. Как правило они оканчиваются точкой с запятой.
...
Есть и инструкции, после которых точка с запятой не ставится. Это условия и циклы.
...
Так вот, фигурные скобки нужны, чтобы группировать инструкции в блоки. Поэтому если в какой-то ветке условия требуется выполнить больше одной инструкции, фигурные скобки в ней **обязательны.** Если же требуется выполнить только одну инструкцию, их **можно** опустить:
...
- Инструкции (statements) — это фрагменты кода, выполняемые последовательно. Как правило они оканчиваются точкой с запятой `;`.
- Условия и циклы — тоже инструкции. Но после них `;` не требуется.
- Фигурные скобки объединяют инструкции в блоки.
- В теле условия или цикла можно опустить фигурные скобки, если оно состоит из единственной инструкции.
