...
Ветка `else` может отсутствовать. Каждая ветка условия состоит строго из одной инструкции (statement). Как вы [помните,](/courses/cpp/chapters/cpp_chapter_0020/#block-statements) инструкции (statements) — это фрагменты кода, выполняемые последовательно. Инструкции бывают трех видов: простые, составные и управляющие.
...
Каждая ветка условия содержит _только одну_ инструкцию, будь то простая, составная или управляющая инструкция. Отсюда проистекают правила расстановки фигурных скобок.
