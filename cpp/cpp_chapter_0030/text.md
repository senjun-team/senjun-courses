...
Фигурные скобки объединяют [инструкции](/courses/cpp/chapters/cpp_chapter_0020/#block-statements) в блоки. Если требуется выполнить только одну инструкцию, их можно опустить:
