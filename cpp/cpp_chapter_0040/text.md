...
Циклы относятся к управляющим инструкциям. Тело цикла состоит из единственной инструкции. Это может быть простая инструкция, блок (составная инструкция) или управляющая инструкция (например, условие или вложенный цикл). Правила расстановки фигурных скобок в теле цикла точно [такие же,](/courses/cpp/chapters/cpp_chapter_0030/#block-braces) как для условий `if-else`.
