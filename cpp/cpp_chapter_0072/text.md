...
Зачастую одним словом называют и абстрактный тип данных, и одну (например, саму распространённую) из его реализаций, и, если речь идёт о конкретном языке программирования — соответствующий класс. Так, класс С++ "дек" — это реализация одноимённого АТД "Дек".
