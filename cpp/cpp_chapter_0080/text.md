...
Этот код делает то же самое, но выглядит короче и работает быстрее. Откройте оба примера в Playground и убедитесь в этом. Похожий пример с объяснениями причин ускорения мы [приводили,](/courses/cpp/chapters/cpp_chapter_0010/#block-zero-overhead) когда описывали одно из достоинств C++ — абстракции с нулевой стоимостью.
