...
В стандартной библиотеке [собраны](https://cppreference.com/w/cpp/algorithm.html) десятки алгоритмов на все случаи жизни. Постоянно практикуйтесь и накапливайте опыт их использования. Это сделает ваш код более выразительным и эффективным. А замотивирует вас доклад Михаила Матросова [«Повседневный С++»,](https://www.youtube.com/watch?v=LuaNbkRPGRo) в котором наглядно показано, что правильный выбор алгоритмов кратно сокращает объем кода. Докладу почти 10 лет, но актуальности он не потерял.
