...
```consoleoutput {.task_source #cpp_chapter_0101_task_0030}
```
...
```cpp {.task_source #cpp_chapter_0101_task_0040}
...
```consoleoutput {.task_source #cpp_chapter_0101_task_0050}
```
