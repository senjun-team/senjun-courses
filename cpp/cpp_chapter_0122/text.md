# Глава 12.2. Инициализация полей классов
...
```consoleoutput {.task_source #cpp_chapter_0122_task_0010}
```
В прошлой главе вы уже [сталкивались](/courses/cpp/chapters/cpp_chapter_0121/#block-use-not-initialized) с подобным кодом, в котором в выражении участвовал ещё не проинициализированный объект. В этом коде поле класса иницилизируется собой. {.task_hint}
```cpp {.task_answer}
ub
```
...
```consoleoutput {.task_source #cpp_chapter_0122_task_0020}
```
