...
- Тип с пустым набором значений `void`. Один из сценариев его применения — в качестве типа возвращаемого значения функции, которая ничего не возвращает.
