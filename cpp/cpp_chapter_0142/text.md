...
У каждой функции есть [сигнатура.](https://timsong-cpp.github.io/cppwp/n4868/defns.signature) Это часть объявления, в которую входит пространство имён функции, её имя и типы параметров. Тип возвращаемого значения _не входит_ в сигнатуру. Дело в том, что у функции могут быть [перегрузки,](/courses/cpp/chapters/cpp_chapter_0050/#block-overloading) отличающиеся набором параметров. И именно сигнатура помогает компилятору выбрать нужную перегрузку по каждому месту вызова.
