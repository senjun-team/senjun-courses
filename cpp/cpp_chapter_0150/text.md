...
Главное при этом — помнить, что ссылка должна указывать на живой, еще не уничтоженный объект. Иначе вы получите висячую ссылку (dangling reference), которая смотрит на несуществующий объект. Обращение по такой ссылке приведет к UB. Например:
...
- Переменную со [статическим временем жизни.](/courses/cpp/chapters/cpp_chapter_0090/#block-static-lifetime)
- Ту же переменную, что была передена в функцию по ссылке в качестве аргумента.
- Поле класса. В этом случае ссылку на него возрвщает не свободная функция, а метод класса.



## Висячие ссылки

## Ссылки в коде в стиле Си
