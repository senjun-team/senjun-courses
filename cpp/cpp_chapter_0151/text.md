...
- Подбирать эффективные алгоритмы. Например, за счет понимания, _почему_ у какого-то метода контейнера сложность — _амортизированная_ константа `O(1)`, а у другого — просто константа `O(1)`.
