...
Адресная арифметика — один из столпов низкоуровневого программирования. Она позволяет эффективно перемещаться по непрерывной области памяти, если вы знаете, элементы какого типа в ней расположены.
