# Глава 15.2. Основы работы с указателями

О том, что такое указатели, мы поговорили в [предыдущей главе.](/courses/cpp/chapters/cpp_chapter_0151/#block-pointer-definition) Указатель — это переменная, хранящая адрес. Пора разобраться, что с ней можно делать.
...
```consoleoutput {.task_source #cpp_chapter_0152_task_0050}
```
...
```consoleoutput {.task_source #cpp_chapter_0152_task_0070}
```
...
```cpp {.task_source #cpp_chapter_0152_task_0090}
