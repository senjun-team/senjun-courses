...
Указатели считаются итераторами [произвольного доступа](/courses/cpp/chapters/cpp_chapter_0061/#block-iterator-categories) (random access). А значит, их можно передавать во все алгоритмы стандартной библиотеки, принимающие итераторы!
