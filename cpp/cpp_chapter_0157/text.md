...
Функция `std::make_unique()` защищает от подобных утечек, если проект компилируется со стандаром до C++17. Эта гарантия безопасности называется _exception safety._ 
