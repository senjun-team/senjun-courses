...
Записывать строку в двойных кавычках гораздо удобнее, чем перечислять посимвольно. Поэтому определяйте строку как массив только в случае, если хотите избежать автоматического добавления терминирующего нуля.
