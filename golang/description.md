Язык Go — компилируемый многопоточный язык программирования. Разработка началась внутри компании Google с 2007 года. Компилятор языка — компилятор с открытым исходным кодом.
