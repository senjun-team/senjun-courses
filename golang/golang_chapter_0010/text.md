...
Сборщик мусора обеспечивает безопасную работу с памятью, очищая ее от недостижимых объектов автоматически. Это облегчает работу, однако не освобождает от необходимости помнить о возможных утечках памяти. Неиспользуемые объекты не будут уничтожены, если на них ссылаются другие объекты.
