...
В Go, если какая-либо из возвращаемых переменных не нужна, вместо имени нужно поставить пустой идентификатор `_`. Например:
...
При работе с массивами нужно учитывать следующую особенность:
