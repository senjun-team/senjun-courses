...
В Go 1.10 появился тип `strings.Builder`. Когда необходимо выполнять конкатенацию строк многократно, то используют его. Это на порядок эффективнее. Откройте пример кода в плэйграунде и убедитесь в этом:
