...
В этой главе мы поговорим об одном из ключевых понятий параллельного кода на Go — конвейерах. Ковейеры позволяют организовать работу горутин особым образом, тем самым увеличивая производительность ряда программ.
