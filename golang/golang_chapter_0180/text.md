...
В этой главе мы поговорим об одном из ключевых паттернов проектирования — конвейерах. Он нужен, чтобы разбить сложную задачу на несколько простых. Для этого выход предыдущей задачи делают входом последующей. Таким образом соединяют задачи в цепочку.

Мы рассмотрим некоторые типичные ситуации, когда лучше использовать канал с буфером, а когда — без него. 

Также читателю предлагается решить задачу по поиску утечки горутин.
...
## Резюме 
1. В разных ситуациях бывает удобно применять как канал с буфером, так и без него. Небуферизованные каналы бывают полезны, когда необходимо синхронизировать работу горутин. Буферизованные каналы позволяют увеличить эффективность взаимодействия горутин. 
