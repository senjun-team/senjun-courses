...
GOGC определяет компромисс между производительностью сборщика мусора и памятью, которую он использует. Он определяет целевой размер кучи после каждого цикла сборки мусора.
