...
### Диапазон значений GOGC 

GOGC может принимать значения в следующем диапазоне. 
...
* [`min.Int64; 0)` — аналогично значению `off`.
...
* `[101; max.Int64]` — более редкая сборка, выше производительность, но растет и потребление памяти.
