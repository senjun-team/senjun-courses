...
В этом коротком примере вся программа сводится к вызову [функции](/courses/python/chapters/python_chapter_0040/) вывода текста. В ней нет подключения модулей, объявления переменных, классов, функций. Что ж, усложним код. 
