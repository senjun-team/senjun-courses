...
**Важное замечание про f-строки:** при использовании оператора моржа внутри f-строк его необходимо заключать в круглые скобки. Без скобок `:=` будет интерпретирован как часть спецификатора формата, а не как оператор присваивания.
...
Подробнее о форматировании строк и f-строках вы узнаете [в главе 10.](/courses/python/chapters/python_chapter_0100#block-formatting) 
