...
В теле функции сначала проитерируйтесь по всем позиционным аргументам, а затем — по всем именованным аргументам, чтобы вывести их по одному в консоль. {.task_text}
