...
Понимание того факта, что функции являются объектами первого класса, пригодится в главах про [декораторы](/courses/python/chapters/python_chapter_0270/) и [функции высших порядков.](http://127.0.0.1:8001/courses/python/chapters/python_chapter_0280/)
