...
```python {.task_source #python_chapter_0080_task_0030}
...
```python {.task_source #python_chapter_0080_task_0040}
vals = "1:10:89"
```
```{.task_hint}
y = vals[5:]
...
```python {.task_source #python_chapter_0080_task_0050}
```
```{.task_hint}
...
```python {.task_source #python_chapter_0080_task_0060}
```
```{.task_hint}
def count(s, c):
    return s.count(c)
...
```python {.task_source #python_chapter_0080_task_0070}
```
```{.task_hint}
