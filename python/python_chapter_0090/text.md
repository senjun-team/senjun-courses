...
Создайте переменную `hex_val`, которая соответствует значиню 16 в десятеричной системе счисления, но записано в шестнадцатеричной системе счисления. {.task_text}
