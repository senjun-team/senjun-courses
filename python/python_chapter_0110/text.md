...
Видно, что значение `allocacapacityted` увеличивается не на каждый элемент, а скачкообразно — в соответствии с описанной формулой. Это подтверждает, что `append()` имеет *амортизированную* сложность O(1).
