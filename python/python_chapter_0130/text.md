...
С помощью диапазона в цикле `for` выведите в консоль только четные значения от 8 до 0 включительно: 8, 6 и тд. Каждое число должно быть на новой строке. {.task_text}
