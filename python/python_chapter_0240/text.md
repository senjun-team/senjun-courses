...
Вы только что увидели, как выглядят comprehensions под капотом. Это не более чем синтаксический сахар, надстройка над вызовом конструктора типа от генераторного выражения.

## Почему list comprehensions быстрее обычных циклов?
Хотя все comprehensions можно выразить через конструкторы и генераторные выражения, list comprehensions имеют важную оптимизацию в CPython, делающую их быстрее обычных циклов с append(). Рассмотрим детали:
...
```commandline
  ...
  1           2 PUSH_NULL
        ...
        >>   26 FOR_ITER                 4 (to 38)
             ...
             34 LIST_APPEND              2             # Ключавая оптимизация работает на уровне C, 
