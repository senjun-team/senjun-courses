...
```consoleoutput {.task_source #python_chapter_0250_task_0010}
```
```{.task_hint}
...
```python {.task_source #python_chapter_0250_task_0020}
import random
import string
...
```python {.task_source #python_chapter_0250_task_0060}
# Your code here
...
- `@classmethod` и `@staticmethod` делают метод методом класса или статическим методом. Мы [рассматривали их](/courses/python/chapters/python_chapter_0140#block-classmethod) в главе про классы и объекты.
- `@abstractmethod` помечает метод как абстрактный. Мы [рассматривали его](/courses/python/chapters/python_chapter_0150#block-abstract) в главе про полиморфизм.
