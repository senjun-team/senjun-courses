# Глава 26. Функции высших порядков
...
```python {.task_source #python_chapter_0260_task_0020}
...
```python {.task_source #python_chapter_0260_task_0030}
products = {"corn": 5.2, "noodle": 6.5, "mayonnaise": 1.0}
```
```{.task_hint}
...
```python {.task_source #python_chapter_0260_task_0060}
...
```python {.task_source #python_chapter_0260_task_0070}
```
```{.task_hint}
def match(*args):
...
```python {.task_source #python_chapter_0260_task_0080}
a = ["A", "B", "C"]
b = ["D", "E", "F"]
...
```python {.task_source #python_chapter_0260_task_0090}
