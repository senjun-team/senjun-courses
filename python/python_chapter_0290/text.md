...
```python {.task_source #python_chapter_0290_task_0010 .run_static_type_checker}
class Storage():
...
```python {.task_source #python_chapter_0290_task_0020 .run_static_type_checker}
...
```python {.task_source #python_chapter_0290_task_0030 .run_static_type_checker}
import sys
...
```python {.task_source #python_chapter_0290_task_0040 .run_static_type_checker}
def format(d):
