...
```consoleoutput {.task_source #python_chapter_0320_task_0020}
```
```{.task_hint}
...
```consoleoutput {.task_source #python_chapter_0320_task_0030}
```
```{.task_hint}
