...
## Мотивация
Атрибуты объектов класса хранятся в dunder-поле `__dict__` типа `dict`. Мы [разбирали это](1/courses/python/chapters/python_chapter_0160#block-dict) в главе про модель данных в питоне.
...
```consoleoutput {.task_source #python_chapter_0330_task_0030}
```
```{.task_hint}
...
Добавление в класс слотов приводит к некоторым **сложностям** при [наследовании,](/courses/python/chapters/python_chapter_0150/) при [множественном наследовании](/courses/python/chapters/python_chapter_0150#block-multiple-inheritance) и при заведении [слабых ссылок](https://docs.python.org/3/library/weakref.html) (weak references) на объекты класса.
...
**Слоты и множественное наследование.** Не получится отнаследоваться от нескольких родителей, если более чем у одного из них определены слоты. Эту проблему можно обойти с помощью [абстрактных классов.](/courses/python/chapters/python_chapter_0150#block-abstract-classes)
